...
DEFAULT_ADS = [
    {
        "thumbnail": "https://ik.imagekit.io/partiful/tr:f-auto,fo-auto,pr-true,w-800,dpr-auto/user/hjjMsPmsF4dMR4r0s1uRb4ryOxV2/dea-LIWFUN6IBTc0pl5OG",
...
if submit_button and user_input:
    ...
    st.session_state["ads"] = ad_list + st.session_state["ads"]
...
if st.session_state["generated"]:
    with response_container:
        for i in range(len(st.session_state["generated"])):
            ...
            message.write(st.session_state["past"][i])

            message = st.chat_message("assistant", avatar="ant.png")
            message.write(st.session_state["generated"][i])
